<#macro show social>
    ...
    <div id="kc-social-providers" class="w-full text-gray-800 flex flex-wrap items-center justify-center gap-4">
        <#list social.providers as p>
            <a id="social-${p.alias}" class="py-2 px-3 flex items-center space-x-2 w-max rounded-lg border border-gray-300 hover:bg-gray-50 transition" aria-label="${p.displayName}" type="button" href="${p.loginUrl}">
                    <span>
                        <#switch p.alias>
                            <#case "google">
                                <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 488 512">
                                    <title id="title">Google</title>
                                    <path d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"/>
                                </svg>
                                <#break>
                            <#case "github">
                                <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 496 512">
                                ...
                                <#break>
                            <#case "facebook">
                                <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 448 512">
                                    <title id="title">Facebook</title>
                                    <path d="M448 56.7v398.5c0 13.7-11.1 24.7-24.7 24.7H309.1V306.5h58.2l8.7-67.6h-67v-43.2c0-19.6 5.4-32.9 33.5-32.9h35.8v-60.5c-6.2-.8-27.4-2.7-52.2-2.7-51.6 0-87 31.5-87 89.4v49.9h-58.4v67.6h58.4V480H24.7C11.1 480 0 468.9 0 455.3V56.7C0 43.1 11.1 32 24.7 32h398.5c13.7 0 24.8 11.1 24.8 24.7z"/>
                                </svg>
                                <#break>
                            <#case "gitlab">
                                <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 512 512">
                            ...
                            <#case "openshift-v3">
                            <#case "openshift-v4">
                                <svg viewBox="116 0 100 100" aria-hidden="true" class="w-4 h-4">
                                ...
                                <#break>
                            <#case "stackoverflow">
                                <svg viewBox="0 0 384 512" aria-hidden="true" class="w-4 h-4">
                                ...
                                <#break>
                            <#case "twitter">
                                <svg viewBox="0 0 512 512" aria-hidden="true" class="w-4 h-4">
                                ...
                                <#break>
                            <#case "microsoft">
                                <svg viewBox="0 0 448 512" aria-hidden="true" class="w-4 h-4">
                            ...
                            <#case "paypal">
                                ...
                                <#break>
                            <#default>
                                <span class="${p.iconClasses!}" aria-hidden="true" class="w-4 h-4">
                                    <svg viewBox="0 0 512 512" aria-hidden="true" class="w-4 h-4">
