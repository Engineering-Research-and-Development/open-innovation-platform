...
const KC_ACTION_CLASS = "float-right my-2 ml-2 border text-xs py-0.5 px-2 rounded hover:bg-gray-50 hover:border-gray-300 transition";
...
function createRemoveAction(element, _isLastElement) {
    let text = "Remove";
